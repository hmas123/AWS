...
class Config(object):  
  ...
  AWS_S3_KEY_PREFIX = "hamadm/"
  AWS_S3_ACL = "private"
  AWS_S3_ENCRYPTION = "AES256"

  AWS_GLACIER_VAULT = "ucmpcs"

  AWS_SQS_GLACIER = "hamadm_glacier"
  AWS_SQS_GLACIER_ARCHIVE = "hamadm_glacier_archive"
  AWS_SQS_JOB_RESULTS="hamadm_job_results"
  # Change the ARNs below to reflect your SNS topics
  AWS_SNS_JOB_REQUEST_TOPIC = "arn:aws:sns:us-east-1:127134666975:hamadm_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = "arn:aws:sns:us-east-1:127134666975:hamadm_job_results"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "hamadm_annotations"

  # Stripe API keys
  STRIPE_PUBLIC_KEY = "pk_test_a0AGFRBGX1rdJ4A0yi0aV2jx"
  STRIPE_SECRET_KEY = "sk_test_idLjk42AKR3vrFjCVP8VbGFp"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "hamadm@ucmpcs.org"
